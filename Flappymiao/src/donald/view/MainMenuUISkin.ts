...
module game{
    export class MainMenuUISkin extends egret.gui.Skin{
        ...
        public createChildren():void{
			...
			background.height = Constants.menuHeight;
            this.addElement(background);

            var icon_life = new egret.gui.UIAsset;
            icon_life.source = "mr.pudding";
			icon_life.x = 0 * Constants.Scale;
            icon_life.y = 75 * Constants.Scale;
            icon_life.height = 80 * Constants.Scale;
            icon_life.width = 91 * Constants.Scale;
            this.addElement(icon_life);

            this.label_life = new egret.gui.Label;
            this.label_life.text = "× 3";
            this.label_life.x = 180 * Constants.Scale;
            this.label_life.textColor = 0x666666;
            this.label_life.y = 75 * Constants.Scale;
            this.label_life.size = 80 * Constants.Scale;
            ...
            icon_star.y = 75 * Constants.Scale;
            icon_star.height = 80 * Constants.Scale;
            icon_star.width = 80 * Constants.Scale;
            this.addElement(icon_star);

            this.label_score = new egret.gui.Label;
            this.label_score.text = "0";
            this.label_score.x = 580 * Constants.Scale;
            this.label_score.textColor = 0x666666;
            this.label_score.y = 75 * Constants.Scale;
            this.label_score.size = 80 * Constants.Scale;
